...
export const SEMANTIC_GROUPS: TokenGroup[] = [
  ...
  },
  {
    ...
    tokens: [
      ...
      { name: '--color-text-error', label: 'Error', defaultValue: 'var(--red-11)', type: 'color' },
      { name: '--color-text-success', label: 'Success', defaultValue: 'var(--green-11)', type: 'color' },
      { name: '--color-text-warning', label: 'Warning', defaultValue: 'var(--yellow-11)', type: 'color' },
