 ...
 *
 * Renders a 32×32 brand-teal mark with the Shilp Sutra glyph. Both light and
 * dark mode browser chromes show the same artwork. Corner radius (~25% of
 * canvas) matches the squircle-style rounding used on the source logo mark
 * (Figma node 103:1277 — 120px radius / 464px size).
 */
...
export default function Icon() {
  return new ImageResponse(
    (
      ...
      >
        <svg width="20" height="17" viewBox="0 0 338 289.599" fill="none" xmlns="http://www.w3.org/2000/svg">
