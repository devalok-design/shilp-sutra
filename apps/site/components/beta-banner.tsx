...
export function BetaBanner() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-page-x py-ds-02 flex items-center justify-center">
      ...
      <button
        ...
        className="absolute right-1 top-1/2 -translate-y-1/2 shrink-0 rounded-control-inner p-ds-01 text-accent-11 hover:bg-accent-3 transition-colors duration-fast-01 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-8"
      >
