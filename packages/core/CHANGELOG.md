...
- [#246](https://github.com/devalok-design/shilp-sutra/pull/246) [`db55025`](https://github.com/devalok-design/shilp-sutra/commit/db55025873fe10ad95b8c97efe5515422a4a0cc3) Thanks [@Mudit-Lal](https://github.com/Mudit-Lal)! - build!: externalize TipTap + the class utilities, drop `use-sync-external-store`, and remove the `postinstall` entirely
