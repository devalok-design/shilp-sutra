...
export const Default: Story = {
  args: {
    children: (
      <div>
        <p style={{ margin: 0, color: 'var(--color-surface-fg)', fontSize: 14 }}>
  ...
  args: {
    ...
    children: (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        <p style={{ margin: 0, color: 'var(--color-surface-fg-muted)', fontSize: 13 }}>
  ...
  args: {
    ...
    footer: (
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <span style={{ fontSize: 12, color: 'var(--color-surface-fg-subtle)' }}>
    ...
    children: (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          <span style={{ fontSize: 13, color: 'var(--color-surface-fg-muted)' }}>Completed</span>
          <span style={{ fontSize: 13, fontWeight: 600, color: 'var(--color-surface-fg)' }}>
            18 / 24
          </span>
        </div>
        <div
