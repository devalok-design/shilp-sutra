...
const DateTimePicker = React.forwardRef<HTMLButtonElement, DateTimePickerProps>(
  ...
  const selectBase =
    'h-ds-sm rounded-control border border-surface-border-interactive bg-surface-panel-hover px-ds-02 text-body-md text-surface-fg transition-colors duration-fast-01 ease-productive-standard hover:border-surface-border-interactive-strong focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-accent-9 cursor-pointer appearance-none'
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          ...
          {...props}
          className={cn(
            'inline-flex h-ds-sm-plus items-center gap-ds-03 rounded-surface border border-surface-border-interactive bg-surface-panel-hover px-ds-04 text-left transition-colors duration-fast-01 ease-productive-standard',
            'hover:border-surface-border-interactive-strong',
