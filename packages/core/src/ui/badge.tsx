...
const badgeVariants = cva(
  'inline-flex items-center gap-ds-02b font-sans font-medium rounded-ds-full border',
  {
    ...
    compoundVariants: [
      ...
      // "destructive" alias → solid + error
      { variant: 'destructive', color: 'default', className: 'bg-error text-accent-fg border-transparent' },
      { variant: 'destructive', color: 'error', className: 'bg-error text-accent-fg border-transparent' },
      ...
      { variant: 'subtle', color: 'accent', className: 'bg-accent-subtle text-accent-9 border-accent-9' },
      ...
      { variant: 'solid', color: 'info', className: 'bg-info text-accent-fg border-transparent' },
      { variant: 'solid', color: 'success', className: 'bg-success text-accent-fg border-transparent' },
      { variant: 'solid', color: 'error', className: 'bg-error text-accent-fg border-transparent' },
      { variant: 'solid', color: 'warning', className: 'bg-warning text-accent-fg border-transparent' },
      ...
      { variant: 'solid', color: 'teal', className: 'bg-category-teal text-accent-fg border-transparent' },
      { variant: 'solid', color: 'amber', className: 'bg-category-amber text-accent-fg border-transparent' },
      { variant: 'solid', color: 'slate', className: 'bg-category-slate text-accent-fg border-transparent' },
      { variant: 'solid', color: 'indigo', className: 'bg-category-indigo text-accent-fg border-transparent' },
      { variant: 'solid', color: 'cyan', className: 'bg-category-cyan text-accent-fg border-transparent' },
      { variant: 'solid', color: 'orange', className: 'bg-category-orange text-accent-fg border-transparent' },
      { variant: 'solid', color: 'emerald', className: 'bg-category-emerald text-accent-fg border-transparent' },
      // outline (border only)
      ...
      { variant: 'outline', color: 'accent', className: 'bg-transparent text-accent-9 border-accent-9' },
