...
export const Default: Story = {
  render: () => (
    <ContextMenu>
      <ContextMenuTrigger className="flex h-[200px] w-[350px] items-center justify-center rounded-surface border border-dashed border-surface-border-strong text-ds-sm text-surface-fg-muted">
        Right-click here
      </ContextMenuTrigger>
