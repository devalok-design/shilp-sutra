...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex cursor-default select-none items-center gap-ds-03 rounded-ds-md px-ds-03 py-ds-02b text-ds-md outline-none transition-colors duration-fast-01 hover:bg-surface-2 focus:bg-surface-2 focus:text-surface-fg active:bg-surface-3 data-[disabled]:pointer-events-none data-[disabled]:opacity-action-disabled [&>svg]:h-ico-sm [&>svg]:w-ico-sm [&>svg]:shrink-0',
      inset && 'pl-ds-07',
      className,
    )}
    {...props}
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      'relative flex cursor-default select-none items-center rounded-ds-md py-ds-02b pl-ds-07 pr-ds-03 text-ds-md outline-none transition-colors duration-fast-01 hover:bg-surface-2 focus:bg-surface-2 focus:text-surface-fg active:bg-surface-3 data-[disabled]:pointer-events-none data-[disabled]:opacity-action-disabled',
      className,
    )}
    checked={checked}
    {...props}
