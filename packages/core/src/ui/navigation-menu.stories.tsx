            ...
            <ul className="grid w-[400px] gap-ds-03 p-ds-04">
              <li>
                <NavigationMenuLink asChild>
                  <a
                    href="#"
                    className="block select-none space-y-ds-01 rounded-ds-md p-ds-03 leading-none no-underline outline-none transition-colors hover:bg-surface-raised-hover"
                  >
