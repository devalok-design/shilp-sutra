    ...
    >
      ...
      {Array.from({ length: thumbCount }, (_, i) => (
        <SliderPrimitive.Thumb
          ...
          className="block h-ico-sm w-ico-sm rounded-ds-full border-2 border-accent-7 bg-surface-1 shadow-01 transition-[color,transform] duration-fast-02 hover:scale-110 hover:shadow-02 active:scale-[1.15] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-9 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-action-disabled"
        />
      ))}
    </SliderPrimitive.Root>
  )
