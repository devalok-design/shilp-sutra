...
const Box = ({ children, wide }: { children: React.ReactNode; wide?: boolean }) => (
  <div
    className={cn('rounded-control border border-surface-border-strong bg-surface-panel px-ds-04 py-ds-03 text-ds-sm text-surface-fg', wide && 'w-32')}
  >
    {children}
  </div>
)
...
export const HorizontalCentered: Story = {
  args: {
    ...
    children: (
      <>
        <Box>Short</Box>
        <div className="rounded-control border border-surface-border-strong bg-surface-panel px-ds-04 py-ds-06 text-ds-sm text-surface-fg">
          Tall
        </div>
        <Box>Short</Box>
      </>
