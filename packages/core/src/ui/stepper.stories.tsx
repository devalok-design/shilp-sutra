    ...
    <div className="space-y-ds-06">
      ...
      <div className="flex items-center gap-ds-03">
        <button
          ...
          className="rounded-ds-md border border-surface-border-strong px-ds-04 py-ds-02 text-ds-sm text-surface-fg hover:bg-surface-raised transition-colors disabled:opacity-action-disabled disabled:cursor-not-allowed"
        >
          Back
        </button>
        <button
        ...
        {activeStep > steps.length - 1 && (
          <button
            ...
            className="rounded-ds-md border border-surface-border-strong px-ds-04 py-ds-02 text-ds-sm text-surface-fg hover:bg-surface-raised transition-colors"
          >
            Reset
          </button>
        )}
