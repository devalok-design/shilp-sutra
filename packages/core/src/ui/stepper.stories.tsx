    ...
    <div className="space-y-ds-06">
      ...
      <div className="flex items-center gap-ds-03">
        ...
        <button
          ...
          onClick={() => setActiveStep((s) => s + 1)}
          className="rounded-control bg-accent-9 px-ds-04 py-ds-02 text-ds-sm text-accent-fg hover:opacity-90 transition-opacity disabled:opacity-action-disabled disabled:cursor-not-allowed"
        >
