...
export const BreakAdminSkeleton = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ...
  return (
    <div ref={ref} className={cn("z-base h-fit w-full max-w-layout-body overflow-hidden border-[1px] border-surface-border bg-surface-raised-hover sm:rounded-ds-lg", className)} {...props}>
      {/* Header Section */}
      <div className="flex items-center justify-end bg-surface-raised-hover px-ds-06 py-ds-05b">
      ...
      {/* Content Section */}
      <div className="flex h-fit flex-col border-t-[1px] border-surface-border bg-surface-raised shadow-transparent">
        {/* Tabs */}
        ...
        <div className="h-[400px] border-0 px-ds-06 py-ds-05">
          ...
          <div className="mb-ds-05 ml-ds-06 grid grid-cols-6 items-center gap-ds-05 py-ds-03">
            <Skeleton className="h-5 w-full bg-surface-raised-hover" />
            <Skeleton className="h-5 w-full bg-surface-raised-hover" />
            <Skeleton className="h-5 w-full bg-surface-raised-hover" />
            <Skeleton className="h-5 w-full bg-surface-raised-hover" />
            <Skeleton className="h-5 w-full bg-surface-raised-hover" />
            ...
            {Array.from({ length: 5 }).map((_, index) => (
              ...
              >
                <div className="flex items-center gap-ds-03">
                  ...
                  <Skeleton className="h-5 w-24 bg-surface-raised-hover" />
                </div>
                <Skeleton className="h-5 w-full bg-surface-raised-hover" />
                <Skeleton className="h-5 w-16 bg-surface-raised-hover" />
                <Skeleton className="h-5 w-full bg-surface-raised-hover" />
                <div className="flex items-center gap-ds-03">
