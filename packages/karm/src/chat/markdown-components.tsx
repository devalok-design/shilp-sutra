...
export const markdownComponents = {
  ...
  code: ({
    ...
    return (
      <code className="rounded bg-surface-raised-hover px-ds-02 py-ds-01 text-ds-md">
        {children}
      </code>
    )
  },
  pre: ({ children }: { children?: React.ReactNode }) => (
    <pre className="mb-ds-03 overflow-x-auto rounded-ds-lg bg-surface-raised-hover p-ds-04 text-ds-md">
      {children}
    </pre>
  ),
