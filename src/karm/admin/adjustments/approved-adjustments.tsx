            ...
            <div className="P3 no-scrollbar overflow-y-auto md:max-h-[414px] max-md:h-[calc(100vh-366px)] max-md:max-h-[calc(100vh-366px)] max-md:overflow-visible max-md:overflow-y-auto max-md:overflow-x-visible">
              {adjustments.length === 0 ? (
                ...
                adjustments.map((adjustment) => (
                  <div
                    key={adjustment.id}
                    className="grid grid-cols-[200px_160px_80px_1fr_1fr_1fr] gap-ds-05 bg-[var(--color-layer-02)] py-ds-03 sm:px-ds-06"
                  >
                    <div className="p-[10px] pl-ds-04 text-[var(--color-text-secondary)]">
                    ...
                    <div className="max-w-[350px] p-[10px] pl-ds-04 text-[var(--color-text-tertiary)]">
                      {adjustment.type}
                    </div>
