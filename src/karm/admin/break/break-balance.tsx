  ...
  return (
    <div className="m-0 flex h-[400px] flex-col items-start justify-start p-0 max-md:h-auto">
      <div className="m-0 mx-[4%] mb-4 mt-3 flex w-[92%] items-start justify-start gap-2 p-0 text-gray-500">
        <div className="L3 w-[16.4%] min-w-[120px] px-3 py-[10px] text-[var(--Mapped-Text-Tertiary)]">
          NAME
        </div>
        <div className="L3 w-[16.4%] px-3 py-[10px] text-[var(--Mapped-Text-Tertiary)]">
          Total Balance
        </div>
      </div>
          ...
          >
            <div className="flex w-1/6 min-w-[120px] items-center gap-2 p-3">
              ...
              <div className="w-[calc(100%-36px)]">
                <span className="P3 block w-full cursor-default truncate text-[var(--Mapped-Text-Primary)]">
                  {breakItem.user?.firstName ??
                    breakItem.user?.name?.split(' ')[0]}
                </span>
              </div>
            </div>
            <div className="P3 w-[16.4%] p-[14px] px-3 text-[var(--Mapped-Text-Highlight)]">
              {breakItem.totalDays}
            </div>
          </div>
        ))}
