    ...
    <div className="m-0 flex h-[400px] w-full flex-col items-start justify-start p-0 max-md:h-auto">
      <div className="mx-auto mb-4 mt-3 flex w-[92%] items-center">
        <div className="w-[16%] min-w-[120px] overflow-hidden px-3 py-2">
          <div className="L3 text-[var(--Mapped-Text-Tertiary)]">NAME</div>
        </div>
        <div className="w-[19%] overflow-hidden px-3 py-2">
          <div className="L3 text-[var(--Mapped-Text-Tertiary)]">DATE</div>
        </div>
        <div className="w-[8%] overflow-hidden px-3 py-2">
          <div className="L3 w-full text-center text-[var(--Mapped-Text-Tertiary)]">
            DAYS
          </div>
        </div>
        <div className="w-[22%] overflow-hidden px-3 py-2">
          <div className="L3 text-[var(--Mapped-Text-Tertiary)]">REASON</div>
        </div>
        <div className="flex w-[14%] items-center justify-start overflow-hidden px-3 py-2">
          <div className="L3 text-[var(--Mapped-Text-Tertiary)]">STATUS</div>
        </div>
        <div className="w-[24%] overflow-hidden px-3 py-2">
          <div className="L3 text-[var(--Mapped-Text-Tertiary)]">COMMENT</div>
        </div>
            ...
            >
              <div className="flex w-[16%] min-w-[120px] items-center gap-2 overflow-hidden px-3 py-2">
                ...
                <div className="group relative truncate">
                  <span className="P3 text-[var(--Mapped-Text-Primary)]">
                    {breakItem.user?.name ||
                      breakItem.user?.name?.split(' ')[0]}
                  </span>
                  <div className="P3 invisible absolute left-0 top-full z-10 mt-2 whitespace-nowrap rounded bg-gray-900 px-2 py-1 text-sm text-white shadow-lg group-hover:visible">
                    {breakItem.user?.name}
                  </div>
                </div>
              </div>
              ...
              <div className="w-[19%] overflow-hidden px-3 py-2">
                <span className="P3 whitespace-nowrap text-[var(--Mapped-Text-Secondary)]">
              ...
              <div className="flex w-[8%] items-center justify-center overflow-hidden px-3 py-2">
                <span className="P3 text-center text-[var(--Mapped-Text-Secondary)]">
                  {breakItem.numberOfDays}
                </span>
              </div>

              <div className="w-[22%] overflow-hidden px-3 py-2">
                <span className="P3 text-[var(--Mapped-Text-Tertiary)]">
                  {breakItem.reason}
                </span>
              </div>
