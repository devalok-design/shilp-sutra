...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  tonal: 'bg-[var(--color-layer-02)] text-[var(--color-interactive)]',
  outline: 'bg-transparent border border-solid border-[var(--color-border-strong)] text-[var(--color-interactive)]',
  text: 'text-[var(--color-interactive)]',
}
