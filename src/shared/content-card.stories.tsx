...
export const Default: Story = {
  args: {
    children: (
      <div>
        <p style={{ margin: 0, color: 'var(--Mapped-Text-Primary)', fontSize: 14 }}>
  ...
  args: {
    ...
    children: (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        <p style={{ margin: 0, color: 'var(--Mapped-Text-Secondary)', fontSize: 13 }}>
  ...
  args: {
    ...
    footer: (
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <span style={{ fontSize: 12, color: 'var(--Mapped-Text-Quaternary)' }}>
    ...
    children: (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          <span style={{ fontSize: 13, color: 'var(--Mapped-Text-Secondary)' }}>Completed</span>
          <span style={{ fontSize: 13, fontWeight: 600, color: 'var(--Mapped-Text-Primary)' }}>
            18 / 24
          </span>
        </div>
        <div
          style={{
            height: 4,
            borderRadius: 2,
            background: 'var(--Mapped-Surface-Dark)',
            overflow: 'hidden',
          }}
        >
