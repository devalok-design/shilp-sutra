...
export const WarningState: Story = {
  render: () => (
    <FormField className="max-w-sm">
      ...
      <Input id="password" type="password" state="warning" defaultValue="weak" />
      <FormHelperText state="warning">Password strength is weak. Consider adding numbers and symbols.</FormHelperText>
    </FormField>
  ),
}
...
export const SuccessState: Story = {
  render: () => (
    <FormField className="max-w-sm">
      ...
      <Input id="username" state="success" defaultValue="devalok_user" />
      <FormHelperText state="success">Username is available.</FormHelperText>
    </FormField>
  ),
}
