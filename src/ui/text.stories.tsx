...
export const WithColor: Story = {
  render: () => (
    <div className="flex flex-col gap-ds-03">
      <Text variant="heading-sm" className="text-text-primary">Primary heading</Text>
      <Text variant="body-md" className="text-text-secondary">Secondary body text</Text>
      <Text variant="body-sm" className="text-text-tertiary">Tertiary small text</Text>
      <Text variant="body-md" className="text-text-brand">Brand colored text</Text>
      <Text variant="body-md" className="text-text-error">Error text</Text>
    </div>
  ),
}
